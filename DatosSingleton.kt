 ...
 * @property tag String que indica la etiqueta a usar para los logs
 * @property colorAux Color que indica el color que se ha pulsado
 * @property numeroDeColores Colores que indica el numero de colores que se van a usar en el juego
 * @property listaColores List<Color> que contiene los colores que se van a usar en el juego
 */
